...
- (NSArray *)arrayWithPinYinFirstLetter
{
    ...
    for (contactModel *words in self) {
        NSString *firstLetter = [words.contactName getFirstLetter];
    ...
    for (int i = 'A'; i <= 'Z'; i++) {
        ...
        NSMutableArray *array = dict[firstLetter];
        if ([array count]) {
            [array sortUsingComparator:^NSComparisonResult(contactModel *obj1, contactModel *obj2) {
                NSString *word1 = obj1.contactName;
                NSString *word2 = obj2.contactName;
